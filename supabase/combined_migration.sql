-- =============================================================
-- CrewFlow — Combined Migration (001 → 019)
-- Paste this entire file into the Supabase SQL Editor and run.
-- Order matters: each block depends on earlier ones.
--
-- IMPORTANT: Section 019 seeds the owner profile. Before running,
-- search for the literal string  <rajeev-auth-uid>  and replace it
-- with the UID of the auth.users row you created (Supabase ->
-- Authentication -> Users -> your owner account -> User UID).
-- =============================================================
...
-- -------------------------------------------------------------
-- !!! REMINDER !!!
-- Replace every occurrence of  <rajeev-auth-uid>  below with the
-- actual UID of your auth.users row before running this block.
-- -------------------------------------------------------------
